...
import Keyword_Bomber_Tool_Backend.prompts as prompts
import Keyword_Bomber_Tool_Backend.llm as llm
...
async def suggestions_ai_analysis(keyword_data: str, api_key):
    ...
    for _ in range(max_retries):
        try:
            ...
            bot_result = await llm.generate_response(prompt, LLM_MODEL, api_key)
